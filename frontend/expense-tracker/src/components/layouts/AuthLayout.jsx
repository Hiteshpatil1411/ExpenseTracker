...
import AllT from '../../assets/images/allT.png'
  ...
  return (
    ...
    <div  className='w-screen h-screen md:w-[60vw] px-12 pt-8 pb-12'>
     ...
     <div className="hidden md:block w-[40vw] h-screen bg-violet-50 bg-auth-bg-img bg-cover bg-no-repeat bg-center overflow-hidden p-8 relative">
      ...
      <img src={AllT} alt="AllT Logo" className="w-64 rounded-xl lg:w-[90%] absolute bottom-10 shadow-lg shadow-blue-400/15 "/>
     </div>
...
const StatsInfoCard = ({icon, label, value , color}) => {
  return <div className="flex gap-6 bg-white p-4 rounded-xl shadow-purple-400/10 border border-grey-200/50 z-10">
